...
public class ThreadConfigActivity extends AppCompatActivity {
    ...
    private void setToolbar() {
        ...
        binding.titleBar.toolbar.setNavigationIcon(AppCompatResources.getDrawable(this, R.drawable.ic_arrow_back_ios_24dp));
        binding.titleBar.toolbar.setNavigationOnClickListener(v -> {
            provisionManager.getEspDevice().disconnectDevice();
            finish();
        });
    }
