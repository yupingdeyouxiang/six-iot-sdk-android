...
class BLEProvisionLanding : ManualProvBaseActivity() {
    ...
    private fun initViews() {
        ...
        // Dynamically set the text and hide the arrow
        binding.layoutBleProvisioning.btnScan.textBtn.text = getString(R.string.btn_scan_again)
        binding.layoutBleProvisioning.btnScan.ivArrow.visibility = View.GONE
        binding.layoutBleProvisioning.btnScan.layoutBtn.setOnClickListener(btnScanClickListener)
    ...
    private fun setToolbar() {
        ...
        binding.titleBar.toolbarTitle.text = getString(R.string.title_activity_connect_device)
    }
    ...
    private fun updateProgressAndScanBtn() {
        if (isScanning) {
            binding.layoutBleProvisioning.btnScan.layoutBtn.isEnabled = false
            binding.layoutBleProvisioning.btnScan.layoutBtn.alpha = 0.5f
            ...
            binding.layoutBleProvisioning.btnScan.layoutBtn.isEnabled = true
            binding.layoutBleProvisioning.btnScan.layoutBtn.alpha = 1f
            binding.layoutBleProvisioning.bleLandingProgressIndicator.visibility = View.GONE
